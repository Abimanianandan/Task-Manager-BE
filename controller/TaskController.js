...
//     // ✅ If a specific user is passed, filter by user
//     if (user) {
//       query.user = user;
//     }
...
//     // ✅ Now fetch all tasks based on the dynamic query
//     const allTask = await Task.find(query);
...
//       description: task.description,
//       status: task.status,
//       createdAt: task.createdAt.toLocaleString("en-IN", { timeZone: "Asia/Kolkata" }),
//       updatedAt: task.updatedAt.toLocaleString("en-IN", { timeZone: "Asia/Kolkata" }),
//     }));
